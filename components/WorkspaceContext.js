...
const WS = createContext({workspaces:[],current:null,loading:true,switchWorkspace:()=>{},addWorkspace:async()=>null,updateWorkspace:async()=>{},deleteWorkspace:async()=>{},reload:async()=>{}})
...
export function WorkspaceProvider({children}) {
  ...
  const updateWorkspace = async (id,data) => {
    await supabase.from('workspaces').update(data).eq('id',id)
    await loadWorkspaces()
  }
