...
const WS = createContext({ workspaces:[], current:null, loading:true, switchWorkspace:()=>{}, addWorkspace:async()=>{}, updateWorkspace:async()=>{}, deleteWorkspace:async()=>{}, reload:async()=>{} })
...
export function WorkspaceProvider({ children }) {
  ...
  const switchWorkspace = (ws) => { setCurrent(ws); if(typeof window!=='undefined') localStorage.setItem('gh_workspace', ws.id) }
