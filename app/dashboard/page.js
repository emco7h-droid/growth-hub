      ...
      <div style={{ padding: '20px 24px' }}>
        ...
        {tab === 'overview' && <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 14, marginBottom: 20 }}>
            ...
            <MetricCard label="Offene Aufgaben" value={openTasks} sub={highPrio > 0 ? `${highPrio} hoch priorisiert` : 'Keine kritischen'} icon="✅" color={highPrio > 0 ? '#dc2626' : '#059669'} trend={undefined} onClick={() => router.push('/tasks')} />
          </div>
